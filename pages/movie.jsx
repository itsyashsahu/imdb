...
export default function movie() {
  return (
    <>
      <Header />
      <section class="text-gray-600 body-font overflow-hidden h-4/6">
        <div class="container px-5 py-10 mx-auto">
          <div class="lg:w-4/5 mx-auto flex flex-wrap justify-center">
            ...
            <div class="w-96 h-[30rem] max-w-xs overflow-hidden rounded-lg shadow-md bg-white hover:shadow-xl transition-shadow duration-300 ease-in-out">
              <img
                class="h-full w-full"
                src="https://m.media-amazon.com/images/M/MV5BYmRmYzA4NDItZmI3NS00NWIyLWIzZWEtNGIzZjZlYmY5MzE2XkEyXkFqcGdeQXVyMTEyNzgwMDUw._V1_SX300.jpg"
              />
            ...
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div class="flex mb-4 mr-4">
                <span class="flex items-center mr-4">
                  <span class="text-gray-600">Genre : Action , Drama</span>
                </span>
                <span class="flex ml-3 pl-3 py-0 border-l-2 border-gray-200 space-x-2s">
                  <span class="text-gray-600 ml-3">Year : 2000</span>
                </span>
              </div>
              <p class="leading-relaxed pb-5">
                <span class="text-gray-600">Released On : 2000</span>
                <br />
                <span class="text-gray-600">Runtime : 2000</span>
                <br />
                <span class="text-gray-600">Directors : Atul Agnihotri</span>
                <br />
                <span class="text-gray-600">Actors : Atul Agnihotri</span>
                <br />
                <span class="text-gray-600">Writers : Atul Agnihotri</span>
                <br />
                <span class="text-gray-600">Languages : Atul Agnihotri</span>
                <br />
                <br />
              ...
              <div class="flex justify-between pt-2 border-t-2 border-gray-100 ">
                <span class="flex items-center title-font font-medium text-2xl text-gray-900">
                  Upvotes : 456 &nbsp;
                  <button>
                  <svg
                    width="24px"
