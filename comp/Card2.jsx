  ...
  return (
    <>
      ...
      <Link href={`/${imdbId}`}>
        ...
        <div class="relative bg-cover overflow-hidden rounded-lg shadow-lg h-full w-full transform duration-500 hover:-translate-y-2 cursor-pointer group " style={{backgroundImage:`url(${poster})`}}>
          <div class="bg-black bg-opacity-20 px-10 flex flex-wrap flex-col pb-8 pt-80 hover:bg-opacity-75 transform duration-300">
            <p class="opacity-0 text-white text-xl mb-0 group-hover:opacity-80 transform  -translate-y-20 duration-500">
              {title}
            </p>
            <div class="w-16 h-2 bg-red-500 rounded-full mt-2 group-hover:opacity-80 transform translate-y-20 group-hover:-translate-y-20 duration-300"></div>
            <p class="opacity-0 text-white text-xl group-hover:opacity-80 transform -translate-y-0 group-hover:-translate-y-20 duration-500">
              {genre}
            </p>
          </div>
        </div>
