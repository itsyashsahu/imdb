...
export default function Card2({poster , title ,genre ,imdbId}) {
  ...
  return (
    <>
      <div className="relative h-[36rem] my-1 px-1 w-full h-96 md:w-1/2 lg:my-4 lg:px-4 lg:w-1/4 md:h-[26rem] ">
      <Link href={`/${imdbId}`}>
        ...
        <div className="relative bg-cover overflow-hidden rounded-lg shadow-lg h-full w-full transform duration-500 hover:-translate-y-2 cursor-pointer group " style={{backgroundImage:`url(${poster})`}}>
          <div className="bg-black bg-opacity-20 px-10 h-full flex flex-wrap flex-col pb-8 pt-80 hover:bg-opacity-75 transform duration-300">
